...
| { every: "minute" }
| { every: "hour"; at: MinutesOnHour }
| { every: "day"; at: UTCTime }
| { every: "week"; on: DayOfWeek; at: UTCTime }
| { every: "month"; on: DayOfMonth; at: UTCTime }
| { every: "year"; on: DateInYear; at: UTCTime };

/**
* Cron-based scheduler trigger options with typed expression
*/
export type CronScheduleItem = { cron: string };
...
*/
export type DatabaseTriggerTableEntry =
| string
| { table: string; operations?: ("INSERT" | "UPDATE" | "DELETE")[] };
