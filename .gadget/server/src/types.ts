...
export interface ShopifyWebhookReconciliationTrigger {
  ...
  /* The shop id being reconciled */
  shopId: string;
  /* The shop domain being reconciled */
  shopDomain: string;
...
export type ActionTrigger =
  ...
  | ShopifyWebhookReconciliationTrigger
  | APIActionTrigger
  ...
  | ChatGPTAppInstallTrigger
  | ExternalDatabaseOperationTrigger;
