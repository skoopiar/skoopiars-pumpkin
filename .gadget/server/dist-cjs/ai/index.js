...
class OpenAIResponseStream extends _stream.Readable {
    ...
    constructor(openAIIterable, options = {}){
        super(options), _define_property(this, "openAIIterable", void 0), _define_property(this, "reading", void 0), _define_property(this, "result", void 0), _define_property(this, "responseContentType", "application/octet-stream");
