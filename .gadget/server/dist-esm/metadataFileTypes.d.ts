...
type GadgetModel = {
	...
	/** A comment describing this model to other developers */
	comment?: string | undefined
	/** Whether this model can be searched directly by full text search queries. If false, this model can still be searched through related models. */
	...
	shopify?: {
		...
		fields?: {
			[x: string]: true | {
				...
				/** Whether this field can be searched by full text search queries */
				searchIndex?: boolean | undefined
				/** When to fetch this field's data. 'later' (default) fetches only during reconciliation, 'onWebhook' fetches on webhooks. */
				fetchData?: ("onWebhook" | "later") | undefined
			}
		} | undefined
	} | undefined
};
...
type GadgetSettings = {
	...
	plugins: {
		connections?: {
			shopify?: ({
				apiVersion: "2022-01" | "2022-04" | "2022-07" | "2022-10" | "2023-01" | "2023-04" | "2023-07" | "2023-10" | "2024-01" | "2024-04" | "2024-07" | "2024-10" | "2025-01" | "2025-04" | "2025-07" | "2025-10" | "2026-01" | "2026-04"
	...
	frameworkVersion: "v1.7.0" | "v2.0.0"
	plugins: {
		connections?: {
			shopify?: {
				apiVersion: "2022-01" | "2022-04" | "2022-07" | "2022-10" | "2023-01" | "2023-04" | "2023-07" | "2023-10" | "2024-01" | "2024-04" | "2024-07" | "2024-10" | "2025-01" | "2025-04" | "2025-07" | "2025-10" | "2026-01" | "2026-04"
