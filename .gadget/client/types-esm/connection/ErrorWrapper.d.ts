 ...
 **/ export declare class ErrorWrapper extends Error implements AnyErrorWrapper<GraphQLError | GadgetError> {
    /** @private */ static forClientSideError(error: Error, response?: any): ErrorWrapper;
    /** @private */ static forErrorsResponse(errors: Record<string, any>[], response?: any): ErrorWrapper;
    /** @private */ static forMaybeCombinedError(error?: CombinedError | null): ErrorWrapper | undefined;
    /** @private */ static errorIfDataAbsent(result: FetchableResult & {
        error?: CombinedError | null;
    }, dataPath: string[], paused?: boolean): ErrorWrapper | undefined;
    /** Error message for this error. Derived from the other errors this wraps. */ message: string;
    /**
   ...
   */ response?: any;
    ...
    /** Class name of this error -- always `ErrorWrapper` */ get name(): string;
    toString(): string;
    /**
