import type { AnyFilter, AnyInternalModelManager, InternalFieldSelection, InternalFindListOptions, InternalFindManyOptions, InternalFindOneOptions, RecordShape } from "@gadgetinc/core";
...
export declare const internalFindOneQuery: (apiIdentifier: string, id: string, namespace: string[], select?: InternalFieldSelection) => BuildOperationResult;
export declare const internalFindFirstQuery: (apiIdentifier: string, namespace: string[], options?: InternalFindListOptions) => BuildOperationResult;
export declare const internalFindManyQuery: (apiIdentifier: string, namespace: string[], options?: InternalFindManyOptions) => BuildOperationResult;
export declare const internalCreateMutation: (apiIdentifier: string, namespace: string[], record: RecordData) => BuildOperationResult;
export declare const internalBulkCreateMutation: (apiIdentifier: string, pluralApiIdentifier: string, namespace: string[], records: RecordData[]) => BuildOperationResult;
export declare const internalUpdateMutation: (apiIdentifier: string, namespace: string[], id: string, record: RecordData) => BuildOperationResult;
export declare const internalUpsertMutation: (apiIdentifier: string, namespace: string[], on: string[] | undefined, record: RecordData) => BuildOperationResult;
export declare const internalDeleteMutation: (apiIdentifier: string, namespace: string[], id: string) => BuildOperationResult;
export declare const internalDeleteManyMutation: (apiIdentifier: string, namespace: string[], options?: {
    search?: string;
    filter?: AnyFilter;
}) => BuildOperationResult;
/** The fields for a given record to send to the backend */ export type RecordData = Record<string, any>;
/**
 ...
 */ export declare class InternalModelManager<Shape extends RecordShape = RecordData> implements AnyInternalModelManager<Shape> {
    private readonly apiIdentifier;
    readonly connection: GadgetConnection;
    readonly options: {
        pluralApiIdentifier: string;
        hasAmbiguousIdentifiers?: boolean;
        namespace?: string[];
    };
