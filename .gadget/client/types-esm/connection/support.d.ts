/* eslint-disable @typescript-eslint/no-unused-expressions */ import type { ActionFunctionMetadata, AnyActionFunction, AnySearchableFieldConfig, HasReturnType, RecordShape, SearchableFieldConfig, VariablesOptions } from "@gadgetinc/core";
 ...
 **/ export declare class GadgetInternalError extends Error {
    ...
    /** @private */ causedByClient: boolean;
}
/**
 ...
 */ export interface InvalidFieldError {
    /** Which field of a record this error is for */ apiIdentifier: string;
    /** Human facing string representing the error */ message: string;
}
/**
 ...
 */ export declare class GadgetUnexpectedCloseError extends Error {
    ...
    /** @private */ statusCode: number;
    /** @private */ causedByClient: boolean;
    /** The event that caused the unexpected close */ readonly event: unknown;
...
/**
 * Represents a group of errors that occurred when running a number of operations at once */ export declare class GadgetErrorGroup<Result> extends Error {
    readonly errors: GadgetError[];
    readonly results: Result[] | undefined;
    constructor(/** The list of inner errors that occurred */ errors: GadgetError[], /* Any objects that were successfully processed during the bulk operation (the ones that didn't throw errors) */ results: Result[] | undefined);
    get code(): string;
    name: string;
    /** @private */ get statusCode(): number;
}
/** All the errors a Gadget operation can throw */ export type GadgetError = GadgetOperationError | GadgetInternalError | InvalidRecordError | GadgetNonUniqueDataError | GadgetNotFoundError | GadgetUnexpectedCloseError | GadgetWebsocketConnectionTimeoutError | GadgetErrorGroup<any>;
...
export declare const capitalizeFirstCharacter: (str: string) => string;
...
export declare const getNonNullableError: (response: FetchableResult, dataPath: string[]) => GadgetInternalError | undefined;
...
export declare const gadgetErrorFor: (error: Record<string, any>) => GadgetError;
...
export declare const hydrateRecordArray: <Shape extends RecordShape = any>(response: Result, records: Array<any>) => GadgetRecord<Shape>[];
...
/** Detect if the window object and window.localStorage or window.sessionStorage objects are functional */ export declare const storageAvailable: (type: "localStorage" | "sessionStorage") => boolean;
...
export declare const jsSearchFieldsToGqlSearchFields: (searchFields: AnySearchableFieldConfig) => GraphQLSearchableFieldConfig;
export declare const processBulkActionResponse: <Shape extends RecordShape = any>(defaultSelection: FieldSelection | null, response: any, records: any, modelSelectionField: string, hasReturnType?: HasReturnType | null) => any[] | undefined;
