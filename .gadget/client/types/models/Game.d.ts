...
import { Query, IDsList, PromiseOrLiveIterator, Game, AvailableGameSelection, GameSort, GameFilter, GameSearchFields, CreateGameInput, UpdateGameInput, Scalars, UpsertGameInput } from "../types.js";
...
*/ export type SelectedGameOrDefault<Options extends Selectable<AvailableGameSelection>> = DeepFilterNever<Select<Game, DefaultSelection<AvailableGameSelection, Options, typeof DefaultGameSelection>>>;
/**
 ...
 * }
 * ```
 */ export type GameRecord<Selection extends AvailableGameSelection | undefined = typeof DefaultGameSelection> = DeepFilterNever<GadgetRecord<SelectedGameOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultGameSelection: {
...
declare const modelApiIdentifier: "game";
declare const pluralModelApiIdentifier: "games";
/** Options that can be passed to the `GameManager#findOne` method */ export interface FindOneGameOptions {
    /** Select fields other than the defaults of the record to return */ select?: AvailableGameSelection;
...
/** Options that can be passed to the `GameManager#maybeFindOne` method */ export interface MaybeFindOneGameOptions {
    /** Select fields other than the defaults of the record to return */ select?: AvailableGameSelection;
    /** Run a realtime query instead of running the query only once. Returns an AsyncIterator of new results when the result changes on the backend. */ live?: boolean;
}
/** Options that can be passed to the `GameManager#findMany` method */ export interface FindManyGamesOptions {
    /** Select fields other than the defaults of the record to return */ select?: AvailableGameSelection;
    /** Run a realtime query instead of running the query only once. Returns an AsyncIterator of new results when the result changes on the backend. */ live?: boolean;
    /** Return records sorted by these sorts */ sort?: GameSort | GameSort[] | null;
    /** Only return records matching these filters. */ filter?: GameFilter | GameFilter[] | null;
    /** Search is not enabled for this model. It can be enabled in the model's index options.*/ search?: never;
    /** Which fields on a record to search. If not specified, all searchable fields will be searched. */ searchFields?: GameSearchFields | null;
    first?: number | null;
    last?: number | null;
    after?: string | null;
    before?: string | null;
}
/** Options that can be passed to the `GameManager#findFirst` method */ export interface FindFirstGameOptions {
    /** Select fields other than the defaults of the record to return */ select?: AvailableGameSelection;
    /** Run a realtime query instead of running the query only once. Returns an AsyncIterator of new results when the result changes on the backend. */ live?: boolean;
    /** Return records sorted by these sorts */ sort?: GameSort | GameSort[] | null;
    /** Only return records matching these filters. */ filter?: GameFilter | GameFilter[] | null;
...
/** Options that can be passed to the `GameManager#maybeFindFirst` method */ export interface MaybeFindFirstGameOptions {
    /** Select fields other than the defaults of the record to return */ select?: AvailableGameSelection;
    /** Run a realtime query instead of running the query only once. Returns an AsyncIterator of new results when the result changes on the backend. */ live?: boolean;
    /** Return records sorted by these sorts */ sort?: GameSort | GameSort[] | null;
    /** Only return records matching these filters. */ filter?: GameFilter | GameFilter[] | null;
 ...
 **/ export type CreateGameResult<Options extends CreateGameOptions> = SelectedGameOrDefault<Options> extends void ? void : GadgetRecord<SelectedGameOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/ export type UpdateGameResult<Options extends UpdateGameOptions> = SelectedGameOrDefault<Options> extends void ? void : GadgetRecord<SelectedGameOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/ export type UpsertGameVariables = Omit<UpsertGameInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 * The return value from executing upsert on game
 *
 **/ export type UpsertGameResult<Options extends UpsertGameOptions> = SelectedGameOrDefault<Options> extends void ? void : GadgetRecord<SelectedGameOrDefault<Options>>;
/**
 * A manager for the game model with all the available operations for reading and writing to it.*/ export type GameManager = {
    ...
    create: {
      ...
      * * const gameRecord = await api.game.create({
        ...
        * });
      **/ <Options extends CreateGameOptions>(variables: CreateGameVariables, options?: LimitToKnownKeys<Options, CreateGameOptions>) : Promise<CreateGameResult<Options>>;
        /**
       * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      ...
      * * const gameRecord = await api.game.create({
        ...
        *   },
        * });
      **/ <Options extends CreateGameOptions>(variables: FullyQualifiedCreateGameVariables, options?: LimitToKnownKeys<Options, CreateGameOptions>) : Promise<CreateGameResult<Options>>;
        type: 'action';
        ...
        variablesType: (((FullyQualifiedCreateGameVariables | CreateGameVariables)) | undefined);
    ...
    bulkCreate: {
        ...
        */ <Options extends CreateGameOptions>(inputs: (FullyQualifiedCreateGameVariables | CreateGameVariables)[], options?: LimitToKnownKeys<Options, CreateGameOptions>) : Promise<CreateGameResult<Options>[]>;
        type: 'action';
    ...
    update: {
      ...
      * * const gameRecord = await api.game.update("1", {
        ...
        *   userId: "example value for userId",
        * });
      **/ <Options extends UpdateGameOptions>(id: string, variables: UpdateGameVariables, options?: LimitToKnownKeys<Options, UpdateGameOptions>) : Promise<UpdateGameResult<Options>>;
        /**
       * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      * * const gameRecord = await api.game.update("1", {
        ...
        *   },
        * });
      **/ <Options extends UpdateGameOptions>(id: string, variables: FullyQualifiedUpdateGameVariables, options?: LimitToKnownKeys<Options, UpdateGameOptions>) : Promise<UpdateGameResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        ...
        */ <Options extends UpdateGameOptions>(inputs: (FullyQualifiedUpdateGameVariables | UpdateGameVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateGameOptions>) : Promise<UpdateGameResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateGamesInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateGameVariables | UpdateGameVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableGameSelection;
    ...
    delete: {
      ...
      **/ <Options extends DeleteGameOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteGameOptions>) : Promise<DeleteGameResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        ...
        */ <Options extends DeleteGameOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteGameOptions>) : Promise<DeleteGameResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
      ...
      * * const result = await api.game.upsert({
        ...
        *   userId: "example value for userId",
        * });
      **/ <Options extends UpsertGameOptions>(variables: UpsertGameVariables, options?: LimitToKnownKeys<Options, UpsertGameOptions>) : Promise<UpsertGameResult<Options>>;
        /**
       * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      * * const result = await api.game.upsert({
        ...
        *   },
        * });
      **/ <Options extends UpsertGameOptions>(variables: FullyQualifiedUpsertGameVariables, options?: LimitToKnownKeys<Options, UpsertGameOptions>) : Promise<UpsertGameResult<Options>>;
        type: 'action';
        ...
        variablesType: (((FullyQualifiedUpsertGameVariables | UpsertGameVariables)) | undefined);
        hasAmbiguousIdentifier: false;
    ...
    bulkUpsert: {
        ...
        */ <Options extends UpsertGameOptions>(inputs: (FullyQualifiedUpsertGameVariables | UpsertGameVariables)[], options?: LimitToKnownKeys<Options, UpsertGameOptions>) : Promise<any[]>;
        type: 'action';
...
/**
 * A manager for the game model with all the available operations for reading and writing to it.*/ export declare const GameManager: {
